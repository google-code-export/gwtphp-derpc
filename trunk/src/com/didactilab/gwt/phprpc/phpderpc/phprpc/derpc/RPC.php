...
require_once PHPRPC_ROOT . 'derpc/ClientOracle.php';
require_once PHPRPC_ROOT . 'derpc/SimplePayloadDecoder.php';
require_once PHPRPC_ROOT . 'derpc/SerializationStreamReader.php';
