...
public class NoObjectsReturnTest extends ReturnTestCase {

	public NoObjectsReturnTest(TestConnector<ReturnServiceImpl> connector) {
		super(connector);
	}
	...
	protected void execute() {
		asyncWait();
		service.noObjectsReturn(new AsyncCallback<CustomObject[]>() {
			@Override
