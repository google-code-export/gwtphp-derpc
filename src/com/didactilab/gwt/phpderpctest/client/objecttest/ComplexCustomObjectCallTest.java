...
public class ComplexCustomObjectCallTest extends ObjectTestCase {

	public ComplexCustomObjectCallTest(
	...
	protected void execute() {
		asyncWait();
		ComplexCustomObject obj = new ComplexCustomObject();
		obj.fill();
		service.paramCall(obj, new AsyncCallback<Boolean>() {
			@Override
	...
	public String getTitle() {
		return "Call ComplexCustomObject";
	}
