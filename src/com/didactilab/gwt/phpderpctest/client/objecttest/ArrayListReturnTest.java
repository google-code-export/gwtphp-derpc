...
public class ArrayListReturnTest extends ObjectTestCase {
	...
	protected void execute() {
		asyncWait();
		service.arrayListReturn(new AsyncCallback<ArrayList<CustomObject>>() {
			@Override
			...
			@Override
			public void onSuccess(ArrayList<CustomObject> result) {
				asyncPassEquals(result.size(), 3);
			}
		});
	}
	...
	public String getTitle() {
		return "Return ArrayList<CustomObject>[3]";
	}
