...
public class RpcObjectServiceAdapter implements ObjectServiceImpl {
	
	public static class Connector implements TestConnector<ObjectServiceImpl> {

		@Override
		public ObjectServiceImpl getConnector() {
			return new RpcObjectServiceAdapter();
		}
		
	}

	protected RpcObjectServiceAsync service = GWT.create(RpcObjectService.class);
