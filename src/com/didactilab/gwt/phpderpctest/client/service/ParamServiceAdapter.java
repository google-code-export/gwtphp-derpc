...
public class ParamServiceAdapter implements ParamServiceImpl {
	
	public static class Connector implements TestConnector<ParamServiceImpl> {

		private ParamServiceAdapter adapter = new ParamServiceAdapter();
	...
	protected ParamServiceAsync service = GWT.create(ParamService.class);
