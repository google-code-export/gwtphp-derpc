...
public class ReturnServiceAdapter implements ReturnServiceImpl {
	
	public static class Connector implements TestConnector<ReturnServiceImpl> {

		@Override
		public ReturnServiceImpl getConnector() {
			return new ReturnServiceAdapter();
		}
		
	}
	
	private static ReturnServiceAsync service = GWT.create(ReturnService.class);
